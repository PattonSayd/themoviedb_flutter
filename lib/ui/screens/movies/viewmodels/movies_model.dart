...
abstract class MoviesList {
  static final movies = [
    Movies(
      id: 1,
      imageName: AppAssets.walkingdead,
    ...
    Movies(
      id: 3,
      imageName: AppAssets.oficceInvasion,
    ...
    Movies(
      id: 9,
      imageName: AppAssets.firststeps,
